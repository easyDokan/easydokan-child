...
class ED_CONNECT_Checkout_Manager
{
    ...
    public function render_custom_checkout()
    {
        ...
        foreach (WC()->cart->get_cart() as $cart_item) {
            $raw_subtotal += $cart_item['line_subtotal'];
            if ($tax_enabled) {
                $tax_total += $cart_item['line_subtotal_tax'];
            }
        }
        $subtotal_html = wc_price($raw_subtotal);
                ...
                <div class="ed-box">
                    ...
                    <table class="ed-table">
                                ...
                                <tr>
                                    <td>
                                        <div class="ed-product-meta">
                                            <div
                                                style="width: 50px; height: 50px; overflow: hidden; border-radius: 4px; margin-right: 15px; border: 1px solid #eee;">
                        ...
                        <tfoot>
                            ...
                            <?php if ($tax_enabled && $tax_total > 0): ?>
                                <tr id="ed_tax_row">
                                    <td>ট্যাক্স/ভ্যাট</td>
                                    <td style="text-align: right;">
                                        <span class="ed-tax-total"><?php echo wc_price($tax_total); ?></span>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            <tr>
                                ...
                                <td style="text-align: right;" id="ed_total_preview">
                                    <?php echo wc_price($raw_subtotal + $tax_total + $cost_inside); ?>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
        ...
        <script>
            jQuery(document).ready(function ($) {
                ...
                var taxTotal = parseFloat("<?php echo $tax_total; ?>");
                ...
                $('input[name="ed_cf_shipping_zone"]').on('change', function () {
                    ...
                    var total = subTotal + taxTotal + cost;
